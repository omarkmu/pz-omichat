---UI element for offering text suggestions.
...
function SuggesterBox:new(x, y, width, height)
    local this = ISScrollingListBox:new(x, y, width, height) ---@cast this omichat.SuggesterBox

    setmetatable(this, self)
    self.__index = self

    this.maximumVisibleItems = 5
    this:setFont(UIFont.Medium, 7)
